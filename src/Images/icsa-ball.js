...
export const ACLogo = (props) => (
  <StyledICSABallSVG viewBox="0 0 306.7 305.6" height={props.height} color={props.color} position={props.position} left={props.left} bottom={props.bottom}>
   <g>
	<g>
		<g>
			<g className="st0">
